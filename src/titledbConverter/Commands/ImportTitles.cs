...
public sealed class ImportTitles : AsyncCommand<ImportTitles.Settings>
{
    private readonly IImportTitleService _importTitleService;
    private readonly IOptions<AppSettings> _configuration;
    
    public ImportTitles(IImportTitleService importTitleService, IOptions<AppSettings> configuration)
    {
    ...
    public sealed class Settings : CommandSettings
    {
        ...
        [Description("Specify titles.json file to import")]
    ...
    public override async Task<int> ExecuteAsync(CommandContext context, Settings settings)
    {
        ...
        {
            await _importTitleService.ImportTitlesFromFileAsync(settings.ImportFile);
        }
